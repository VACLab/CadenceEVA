/**
 * http://optimization-js.github.io/optimization-js/
 * https://github.com/optimization-js/optimization-js
 * https://unpkg.com/optimization-js@1.5.0/dist/optimization.js
 */
...
*/
module.exports.minimize_Powell = function (fnc, x0, min_constraint, max_constraint) {
    var eps = 1e-2;
    //var eps = 1e-1;
    ...
    while (!convergence) {
        ...
        for (var i = 0; i < indicies.length; i++) {
            ...
            if ((Math.abs(dx) > eps) && (iterations < 60)) {
                convergence = false;
            }

            let new_value = x[indicies[i]] - alpha * dx;
            if ((new_value <= max_constraint) && (new_value >= min_constraint)) {
